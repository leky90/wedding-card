    ...
    <section className="bg-white px-4 py-16 md:py-24">
      ...
      {index !== null && (
        <div
          ...
          onClick={close}
        >
          <figure className="lb-figure flex max-h-full flex-col items-center" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="relative h-[72vh] w-[88vw] max-w-3xl">
              <img
                ...
                className="lb-img h-full w-full object-contain"
              />
            </div>
          ...
          <button
            ...
            onClick={close}
            aria-label="Đóng"
            className="press absolute right-4 top-4 cursor-pointer rounded-full bg-white/10 p-2.5 text-white transition hover:bg-white/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-soft"
          >
          ...
          <button
            ...
            className="press absolute left-2 top-1/2 -translate-y-1/2 cursor-pointer rounded-full bg-white/10 p-2.5 text-white transition hover:bg-white/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-soft md:left-6"
          >
          ...
          <button
            ...
            aria-label="Ảnh sau"
            className="press absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer rounded-full bg-white/10 p-2.5 text-white transition hover:bg-white/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-soft md:right-6"
          >
